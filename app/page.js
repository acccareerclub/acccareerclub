...
export const metadata = {
  ...
  description: 'ACC Career Club at Adamjee Cantonment College empowers students with career guidance, professional development, and networking opportunities. Join us to build your future today!',
  keywords: [
    'ACC Career Club',
  ...
  openGraph: {
    title: 'ACC Career Club - Empowering Future Leaders at Adamjee Cantonment College',
    description: 'Join ACC Career Club at Adamjee Cantonment College for career guidance, professional development, and networking opportunities. Start building your future today!',
  ...
  twitter: {
    ...
    description: 'Join ACC Career Club at Adamjee Cantonment College for career guidance, professional development, and networking opportunities.',
    site: '@ACCCareerClub',
    creator: '@ACCCareerClub',
    images: ['https://res.cloudinary.com/ffuatrrt/image/upload/v1784889142/CareerClubOpengraph_znaeri.png'],
  },
  robots: {
    index: true,
    follow: true,
