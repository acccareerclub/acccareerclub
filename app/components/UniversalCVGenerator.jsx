...
const UniversalCVGenerator = ({ user }) => {
  ...
  const buildMainBlocks = () => {
    ...
    if (hasExperience) {
      ...
      // Count sub-headings actually shown
  ...
  // ==================== PAGINATE ====================
  const FIRST_PAGE_MAIN_BUDGET = USABLE_PAGE_HEIGHT - 115; // header ~115px on universal
      ...
      <body>
        ...
        {mainPages.map((pageBlocks, pageIdx) => (
          <div className="sheet" key={pageIdx}>
            ...
            {/* Body grid — alignItems: stretch keeps sidebar full height */}
            <div
              style={{
                display: "grid",
